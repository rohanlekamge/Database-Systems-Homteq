...
echo "<a href=prodbuy.php?u_prod_id=".$arrayp['prodId']."><img src=images/".$arrayp['prodPicNameLarge']." height=200 width=200></a>";
echo "</td>";
echo "<td style='border: 0px'>";
echo "<p><h5>".$arrayp['prodName']."</h5>"; //display product name as contained in the array
echo "<p>".$arrayp['prodDescripLong']."</p>";
echo "<b>$".$arrayp['prodPrice']."</b>";
echo "<p><h5>Product Quantity : ".$arrayp['prodQuantity']."</h5>";
